...
btn_adicionar = Button(janela, text="Adicionar", fg="navy", bg="grey", font="Tahoma 12 bold", width=8, height=1, command=adicionarContato)
btn_adicionar.grid(row=3, column=0)

#------------------------botão Editar-----------------------------------------------------------------

btn_editar = Button(janela, text="Editar", fg="navy", bg="grey", font="Tahoma 12 bold", width=8, height=1, command=editarContato)
btn_editar.grid(row=3, column=1)

#------------------------botão Excluir-----------------------------------------------------------------

btn_excluir = Button(janela, text="Excluir", fg="navy", bg="grey", font="Tahoma 12 bold", width=8, height=1, command=deletarContato)
...
#------ criando a acao /bind para quando o usuario clicar num contato da tabela---------------------------
